  ...
  return (
    <>
      {isMobile ? (
        ...
        <Button
          variant="outline"
          className="relative h-10 w-full max-w-xl justify-start rounded-full bg-background/80 border text-sm text-muted-foreground hover:bg-background/90 hover:text-foreground"
          onClick={() => setOpen(true)}
        >
