                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="patient-age" type="number" placeholder="e.g., 8" />
                            </div>
                        </div>

                         <div className="space-y-2">
                            <Label htmlFor="campaign-title">Campaign Title *</Label>
                            <Input id="campaign-title" placeholder="e.g., Help Lakshmi Fight Liver Disease" />
                        </div>

                        <div className="space-y-2">
                            <Label htmlFor="patient-story">Patient's Story *</Label>
                            <Textarea id="patient-story" placeholder="Share the patient's journey, their current struggle, and their hope for the future. A heartfelt story helps donors connect." rows={5} />
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                         <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Input id="funding-goal" type="number" placeholder="e.g., 350000" />
                            </div>
                             <div className="space-y-2">
