...
export default function DiagnosticsDashboard() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-4">Diagnostics Dashboard</h1>
      <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
        ...
        <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">This page is only visible to authenticated users with the 'diagnostics' role.</p>
      </div>
    </div>
  );
}
