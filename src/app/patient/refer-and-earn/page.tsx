        ...
        <div className="max-w-2xl mx-auto space-y-6">
            ...
            <Card className="border-2 text-center">
             ...
             <Card className="border-2">
                ...
                <CardContent>
                     <Button className="w-full border-2" variant="secondary" onClick={handleShare}>
                ...
                <CardContent className="space-y-4">
                    ...
                    <Dialog>
                        <DialogTrigger asChild>
                             <Button disabled={walletBalance === 0} className="w-full h-12 text-base border-2">
                        ...
                        <DialogContent>
                            ...
                            <form className="space-y-4" onSubmit={handleWithdraw}>
                                <div className="space-y-2">
                                    ...
                                    <Input id="account-name" placeholder="Enter name as per bank records" required className="border-2"/>
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="account-number">Bank Account Number</Label>
                                    <Input id="account-number" placeholder="Enter your account number" required className="border-2"/>
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="ifsc-code">IFSC Code</Label>
                                    <Input id="ifsc-code" placeholder="Enter your bank's IFSC code" required className="border-2"/>
                                </div>
                                <Button type="submit" disabled={isWithdrawing} className="w-full border-2">
                                    {isWithdrawing ? (
