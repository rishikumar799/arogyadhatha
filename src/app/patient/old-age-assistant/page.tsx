        ...
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <Tabs defaultValue="book-service" className="w-full">
                <div className="sticky top-16 z-10 bg-background pt-2">
                    <div className="p-1 border-2 border-foreground shadow-md bg-muted rounded-lg max-w-md mx-auto">
                ...
                <TabsContent value="book-service" className="mt-6">
                                                 ...
                                                 <Card key={provider.id} className="p-4 border shadow-sm">
                                                            ...
                                                            <div className="flex flex-wrap items-center gap-2 mt-1">
                                                             ...
                                                             <div className="flex flex-wrap gap-1 mt-2">
                                                                {provider.skills.map(skill => (
                                                                    <Badge key={skill} variant="secondary" className="text-xs border">{skill}</Badge>
                                                                ))}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex items-center justify-between gap-2">
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            <Button variant="outline" size="icon" asChild className="h-9 w-9 border">
                    ...
                    {serviceBookingStep === 'tracking' && assignedProvider && (
                        <Card className="border-2 border-foreground shadow-md max-w-4xl mx-auto">
                            <CardHeader>
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex items-center justify-center sm:justify-start gap-2">
                                                {assignedProvider.skills.map((skill:string) => (
                                                    <Badge key={skill} variant="secondary" className="border">{skill}</Badge>
                                                ))}
                                            </div>
                                        </div>
                                        <div className="flex gap-2">
                                            <Button variant="outline" asChild className="border"><a href={`tel:${assignedProvider.contact}`}><Phone/></a></Button>
                                            <Button variant="outline" className="border"><MessageSquare/></Button>
                                        </div>
                                    </div>
                                </Card>
                                                                ...
                                                                {update.photo && (
                                                                     <Dialog>
                                                                        <DialogTrigger asChild>
                                                                            <Button variant="outline" size="sm" className="h-auto px-2 py-1 text-xs border">
                                    ...
                                    <form onSubmit={handleProviderApplicationSubmit} className="space-y-6">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Button asChild variant="outline" className="w-full justify-start text-left border-dashed border">
                        ...
                        {providerApplicationStatus === 'approved' && (
                            <>
                               <CardHeader>
                                ...
                                <CardContent className="space-y-6">
                                     <Alert className="bg-green-50 border-green-200 text-green-800 [&>svg]:text-green-600 border">
                                    ...
                                    <Card className="border">
                                        ...
                                        <CardContent className="space-y-4">
                                            ...
                                            <Textarea placeholder="Enter status update... e.g., Patient had lunch." rows={2} className="border"/>
                                             <Button variant="outline" asChild className="w-full justify-start text-left border-dashed border">
